...
Gene_expression=read.csv("MMRF_subarray.csv",header=T,sep=",",row.names=1)
...
svmtrain<-train_MM
svmfit<-svm(x=svmtrain[,1:nfea],y=as.factor(svmtrain$label),gamma=0.001,tune.control=tc,kernel = 'radial',probability=TRUE)
