...
model.entrezs<-c(eu_genes_list,U_genes_list,H_genes_list)
...
clinical<-subset(clinical[,c("D_Age","D_ISS","D_PFS","D_PFS_FLAG")])
clinical_UAMS<-clinical
clinical_UAMS$label<-0
for (i in 1:nrow(clinical)){if((clinical$D_PFS_FLAG[i]==1)&(clinical$D_PFS[i]<=9*30.5)){clinical_UAMS$label[i]="1"}
  else if ((clinical$D_PFS_FLAG[i]==1)&(12*30.5>=clinical$D_PFS[i]) &(clinical$D_PFS[i]>9*30.5)){clinical_UAMS$label[i]="2"} 
  else if ((clinical$D_PFS_FLAG[i]==1)&(15*30.5>=clinical$D_PFS[i]) &(clinical$D_PFS[i]>12*30.5)){clinical_UAMS$label[i]="3"} 
  else if ((clinical$D_PFS_FLAG[i]==1)&(18*30.5>=clinical$D_PFS[i]) & (clinical$D_PFS[i]>15*30.5)){clinical_UAMS$label[i]="4"}
  else if ((clinical$D_PFS_FLAG[i]==1)&(21*30.5>=clinical$D_PFS[i]) & (clinical$D_PFS[i]>18*30.5)){clinical_UAMS$label[i]="5"}
  else if ((clinical$D_PFS_FLAG[i]==1)&(24*30.5>=clinical$D_PFS[i]) & (clinical$D_PFS[i]>21*30.5)){clinical_UAMS$label[i]="6"}
  else if ((clinical$D_PFS_FLAG[i]==1)&(30*30.5>=clinical$D_PFS[i]) &(clinical$D_PFS[i]>24*30.5)){clinical_UAMS$label[i]="7"} 
  else {clinical_UAMS$label[i]="8"}}
clinical_UAMS<-subset(clinical_UAMS[,c("D_Age","D_ISS","label")])
clinical_UAMS$D_ISS[is.na(clinical_UAMS$D_ISS)]<-1
...
clinical<-subset(clinical,Study%in%a)
clinical<-subset(clinical[,c("D_Age","D_ISS","D_PFS","D_PFS_FLAG")])
clinical_HOVON<-clinical
clinical_HOVON$label<-0
for (i in 1:nrow(clinical)){if((clinical$D_PFS_FLAG[i]==1)&(clinical$D_PFS[i]<=9*30.5)){clinical_HOVON$label[i]="1"}
  else if ((clinical$D_PFS_FLAG[i]==1)&(12*30.5>=clinical$D_PFS[i]) &(clinical$D_PFS[i]>9*30.5)){clinical_HOVON$label[i]="2"} 
  else if ((clinical$D_PFS_FLAG[i]==1)&(15*30.5>=clinical$D_PFS[i]) &(clinical$D_PFS[i]>12*30.5)){clinical_HOVON$label[i]="3"} 
  else if ((clinical$D_PFS_FLAG[i]==1)&(18*30.5>=clinical$D_PFS[i]) & (clinical$D_PFS[i]>15*30.5)){clinical_HOVON$label[i]="4"}
  else if ((clinical$D_PFS_FLAG[i]==1)&(21*30.5>=clinical$D_PFS[i]) & (clinical$D_PFS[i]>18*30.5)){clinical_HOVON$label[i]="5"}
  else if ((clinical$D_PFS_FLAG[i]==1)&(24*30.5>=clinical$D_PFS[i]) & (clinical$D_PFS[i]>21*30.5)){clinical_HOVON$label[i]="6"}
  else if ((clinical$D_PFS_FLAG[i]==1)&(30*30.5>=clinical$D_PFS[i]) &(clinical$D_PFS[i]>24*30.5)){clinical_HOVON$label[i]="7"} 
  else {clinical_HOVON$label[i]="6"}}
clinical_HOVON<-subset(clinical_HOVON[,c("D_Age","D_ISS","label")])
clinical_HOVON$D_ISS[is.na(clinical_HOVON$D_ISS)]<-1
...
train_MM<-rbind(U_train_MM,H_train_MM)
test_MM<-rbind(U_test_MM,H_test_MM)
